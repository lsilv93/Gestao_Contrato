// Dados de demonstração (só roda se ainda não houver transportadoras).
// Cria 3 transportadoras, contratos, NFs, licenças, manuais e um acesso Cliente:
//   cliente@translog.com.br / cliente123  (vinculado à TransLog)
...
async function main() {
  if ((await prisma.carrier.count()) > 0) {
    console.log("[demo] Já existem transportadoras — nada a fazer.");
    return;
  }
  ...
  console.log("[demo] Dados criados. Acesso Cliente: cliente@translog.com.br / cliente123");
}
